...
public class ProductReceiptService {
    ...
    private final String PRODUCT_RECEIPT_PRODUCTION_ORDER_CENTER = "findAllByProductionOrderId";
     ...
     */
    public Iterable<ModelEntity> getProductsReceiptByProductionOrders(Integer productionOrderId,
                                                                  Optional<Integer> page,
                                                                  Optional<Integer> size)  throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {


        StringBuilder methodName = new StringBuilder(PRODUCT_RECEIPT_PRODUCTION_ORDER_CENTER);
        ...
        return this.dynamicRepositoryCall(this.productReceiptRepository,methodName.toString(),parameters.toArray(new Object[parameters.size()]));
